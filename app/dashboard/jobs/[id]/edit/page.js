...
export default function EditJobPage() {
  ...
  const { data: job, loading: jobLoading, error: jobError } = useJob(params.id);
  const { updateJob, loading, error } = useJobMutations();
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-600">Update the details for your job posting</p>
      </div>
